...
./vendor/bin/typo3 migration:export 123 0 EXT:migration_extend/Configuration/Port.php > /home/user/export.json
```
...
./vendor/bin/typo3 migration:import /home/user/export.json 123 EXT:migration_extend/Configuration/Port.php
```
